const CAMP21 = {
  ...
  // ── DT phases ─────────────────────────────────────────────────────────
  phases: [
    {no:'01', title:'Empathise', desc:'Interview artisans and understand the real cultural heritage challenge.',  icon:'♡',  img:'/Camp21-Synergising-Literacies-2026/assets/icons/icon-empathy.png'},
    {no:'02', title:'Define',    desc:'Frame the right problem rooted in craft and community need.',              icon:'⌕',  img:'/Camp21-Synergising-Literacies-2026/assets/icons/icon-checklist.png'},
    {no:'03', title:'Ideate',    desc:'Generate AI-powered heritage-inspired ideas.',                            icon:'💡', img:'/Camp21-Synergising-Literacies-2026/assets/icons/icon-ideate.png'},
    {no:'04', title:'Prototype', desc:'Build and test with AI visuals, mockups or video.',                       icon:'□',  img:'/Camp21-Synergising-Literacies-2026/assets/icons/icon-prototype.png'},
    {no:'05', title:'Test',      desc:'Gather feedback, refine and prepare your pitch.',                         icon:'✓',  img:'/Camp21-Synergising-Literacies-2026/assets/icons/icon-evidence.png'}
  ],

  // ── Experience grid — 8 cards linking to correct pages ───────────────
  experiences: [
    {
